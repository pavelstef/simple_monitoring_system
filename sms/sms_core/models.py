...
class SmsUser(AbstractUser):
    ...
    name = models.SlugField(max_length=50, unique=True, verbose_name='Username')
...
class Device(models.Model):
    ...
    name = models.SlugField(max_length=20, unique=True, verbose_name='Device name')

    ip_fqdn = models.CharField(max_length=30, unique=True, verbose_name='Device IP / FQDN')
